export default {
  level1: {
    joyful: ['compassionate', 'peaceful', 'proud', 'excited'],
    angry: ['annoyed', 'frustrated', 'furious'],
    afraid: ['nervous', 'dread', 'panicked', 'terrified'],
    disgust: ['dislike', 'repulsed', 'distate', 'loathing'],
    sad: ['disappointed', 'discouraged', 'miserable', 'sorrowful']
  },
  level2: {
